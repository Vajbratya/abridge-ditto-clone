...
import LatestUpdatesSection from "./sections/latest-updates-section";
...
const TextLink_data: TextLinkData[] = [
    { ariacontrols: "nav-panel-0", href: "/produto", label: "Plataforma" },
    { ariacontrols: "nav-panel-1", href: "/radcommons", label: "Ciência" },
    { ariacontrols: "nav-panel-2", href: "/recursos", label: "Recursos" },
    { ariacontrols: "nav-panel-3", href: "/sobre", label: "Sobre" }
];
              ...
              <div className="block relative [font-family:Avantt,_Arial,_sans-serif] w-full" data-cid="n5">
                ...
                <div className="h-15 block relative z-210 px-[4.9375rem] bg-background w-full max-md:px-6 md:max-lg:px-8 2xl:px-24" data-cid="n7">
                  <div className="flex max-w-400 justify-between items-center mx-auto h-full" data-cid="n8">
                    <a className="flex items-center shrink-0 cursor-pointer" data-cid="n9" data-component="link" aria-label="Laudos.AI — home" href="/">
                      <span className="w-28 h-5 block max-w-28 overflow-hidden align-middle text-xl font-semibold leading-5 tracking-[0.02em]" data-cid="n10" data-component="image">LAUDOS.AI</span>
                    </a>
                    ...
                    <div className="flex z-220 items-center shrink-0 gap-3 max-lg:hidden" data-cid="n16">
                      <div className="contents min-w-0 max-md:w-[165.5px] max-lg:h-10 max-lg:block max-lg:flex-1 max-lg:pointer-events-none md:max-lg:w-90.5" data-cid="n17">
                        <div className="block max-lg:pointer-events-none" data-cid="n18">
                          <a className="h-10 border border-solid border-foreground flex px-8 rounded-sm justify-center items-center font-medium cursor-pointer max-lg:pointer-events-none hover:bg-clr-8 focus:bg-clr-10" data-cid="n19" data-component="button" href="/laudo">
                            Entrar
                          </a>
                        </div>
                      </div>
                      <div className="contents min-w-0 max-md:w-[165.5px] max-lg:h-10 max-lg:block max-lg:flex-1 max-lg:pointer-events-none md:max-lg:w-90.5" data-cid="n20">
                        <div className="block max-lg:pointer-events-none" data-cid="n21">
                          <a className="h-10 border border-solid border-primary flex px-8 rounded-sm justify-center items-center text-background font-medium bg-primary cursor-pointer max-lg:pointer-events-none hover:bg-clr-9" data-cid="n22" data-component="button" href="/contato">
                            Agendar demo
                          </a>
                        </div>
                      </div>
