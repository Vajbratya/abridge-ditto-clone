...
/** Awards Delivering Award section. */
export default function AwardsDeliveringAwardSection() {
  return (
    <section className="block relative py-[6.5375rem] px-[4.9375rem] max-md:py-20 max-md:px-6 md:max-lg:py-21 md:max-lg:px-8 2xl:py-32 2xl:px-24" data-cid="n517">
      <div className="block max-w-400 mx-auto" data-cid="n518">
        <div className="block max-w-325 mx-auto" data-cid="n519">
          <div className="grid gap-7 grid-rows-[604.9px] [grid-auto-columns:1fr] grid-cols-2 max-lg:gap-6 max-md:grid-rows-[351.875px_443.625px] max-lg:grid-cols-1 md:max-lg:grid-rows-[461.219px_591.734px] 2xl:gap-8 2xl:grid-rows-[619.7px]" data-cid="n520">
            <div className="h-[604.9px] flex flex-col justify-between items-start [align-self:start] max-md:h-[351.9px] md:max-lg:h-[28.825rem] 2xl:h-[619.7px]" data-cid="n521" id="w-node-_4fe86ae0-4a9a-5c97-cb39-8a4dfa9042c6-7a3581b6">
              <div className="block" data-cid="n522">
                <div className="block" data-cid="n523">
                  <div className="flex flex-col gap-[51.5px] max-lg:gap-11 2xl:gap-15" data-cid="n524">
              ...
              <div className="w-full flex gap-12" data-cid="n541">
                <div className="w-full block" data-cid="n542">
                  <div className="h-full block" data-cid="n543">
                    <div className="h-full border-b border-solid border-b-clr-4 block pb-10 max-md:pb-4" data-cid="n544">
                ...
                <div className="w-full block" data-cid="n549">
                  <div className="h-full block" data-cid="n550">
                    <div className="h-full border-b border-solid border-b-clr-4 block pb-10 max-md:pb-4" data-cid="n551">
            ...
            <div className="w-full max-w-125 block" data-cid="n556" id="w-node-_4fe86ae0-4a9a-5c97-cb39-8a4dfa9042d4-7a3581b6">
                ...
                <div className="h-full block relative rounded-xl overflow-clip bg-color-001 shadow-[var(--color-002)_0px_0px_0px_1px]" data-cid="n558">
                  ...
                  <div className="h-full flex rounded-xl flex-col gap-7 max-lg:gap-6 2xl:gap-8" data-cid="n561">
                    ...
                    <div className="flex pb-9 px-9 flex-col gap-9 max-lg:pb-8 max-lg:px-8 max-lg:gap-8 2xl:pb-10 2xl:px-10 2xl:gap-10" data-cid="n564">
                      ...
                      <div className="block justify-between items-center" data-cid="n570">
                        <div className="block" data-cid="n571">
                          <div className="block" data-cid="n572">
                            <div className="flex justify-between items-center" data-cid="n573">
                              <div className="flex justify-start items-center gap-2.5" data-cid="n574">
                              ...
                              <div className="block" data-cid="n578">
                                <div className="w-11 h-11 border border-solid border-color-002 flex rounded-lg justify-center items-center bg-color-002" data-cid="n579">
                                  <div className="w-6 h-6 flex justify-center items-stretch" data-cid="n580">
                                    <div className="block" data-cid="n581">
                                      <div className="block before:content-['_'] before:table before:w-0 before:h-0 before:text-background before:text-base before:leading-6 after:content-['_'] after:table after:w-0 after:h-0 after:text-background after:text-base after:leading-6" data-cid="n582">
                                        <Icon cid={"n583"} />
                                      </div>
                                    </div>
                                  </div>
