/** Care Workflow Intelligence section. */
export default function CareWorkflowIntelligenceSection() {
  return (
    <section className="block relative py-[6.5375rem] px-[4.9375rem] max-md:py-20 max-md:px-6 md:max-lg:py-21 md:max-lg:px-8 2xl:py-32 2xl:px-24" data-cid="n430">
      <div className="block max-w-400 mx-auto" data-cid="n431">
        <div className="block relative z-2" data-cid="n432">
          <div className="grid gap-[6.5375rem] grid-rows-[218.656px_741.969px] [grid-auto-columns:1fr] grid-cols-1 max-md:gap-9 max-md:grid-rows-[160.688px_1764.98px] md:max-lg:gap-21 md:max-lg:grid-rows-[265.406px_1410.19px] 2xl:gap-32 2xl:grid-rows-[231.406px_866.453px]" data-cid="n433">
            <div className="h-[218.7px] block text-center max-md:h-[160.7px] md:max-lg:h-[16.5875rem] 2xl:h-[14.4625rem]" data-cid="n434">
            ...
            <div className="grid justify-between items-stretch gap-px grid-rows-[742px] [grid-auto-columns:1fr] grid-cols-3 max-md:max-w-full max-lg:flex-col max-md:gap-12 max-md:grid-rows-[538.422px_574.234px_556.328px] max-md:grid-cols-1 md:max-lg:grid-rows-[733.188px_676px] md:max-lg:grid-cols-2 2xl:grid-rows-[866.5px]" data-cid="n443" />
          </div>
        </div>
      </div>
